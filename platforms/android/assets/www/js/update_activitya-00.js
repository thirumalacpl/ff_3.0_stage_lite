...
$.ajax({
  type: "POST",
url: "http://staging.eimpressive.com/slim/slim_four_rips/sdoc.php?verification_user_id="+verification_user_id+"&coordinator_id="+coordinator_id+"&res="+res+"&qualification_id="+qualification_id,
